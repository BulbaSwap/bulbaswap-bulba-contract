...
const proxyAdminAddress = '0x6711E08F7B129406350035aA974F4Ff49f72b88E'
const proxyAddress = '0x5fcd325fe3b46674C9B20685760e2Dc98e2a0A30'
/**
...
const upgradeModule = buildModule('UpgradeModule', (m) => {
    ...
    const encodedFunctionCall = m.encodeFunctionCall(stakingV2, 'setVersion', [3])
    ...
    m.call(
        proxyAdmin,
        'upgradeAndCall',
        [proxy, stakingV2, encodedFunctionCall],
        {
